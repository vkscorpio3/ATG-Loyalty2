    ...
    <table width="700" cellpadding="8">
      <tr>
        ...
        <td valign="top">
		  ...
		  <b>Loyalty points</b><br> 
					Total: <dsp:valueof bean="/atg/userprofiling/ProfileFormHandler.value.loyaltyAmount"/> <br> 
					<dsp:setvalue param="profileId"	beanvalue="/atg/userprofiling/ProfileFormHandler.value.id" /> 
					<dsp:droplet name="/atg/dynamo/droplet/RQLQueryRange">
						...
						<dsp:oparam name="output">
							<li>
								<dsp:valueof param="element.amount" /> points (Date: <dsp:valueof param="element.date" />)
								<p><dsp:valueof param="element.description" /></p>
							</li>
						</dsp:oparam>
						<dsp:oparam name="outputEnd">
							</ul>
