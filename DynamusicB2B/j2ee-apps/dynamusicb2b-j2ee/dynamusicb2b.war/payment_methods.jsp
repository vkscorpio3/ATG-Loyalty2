  ...
  <dsp:droplet name="Switch">
    ...
    <dsp:oparam name="true">
     ...
     <!-- Set the PONumber of the invoiceRequest for the CreateInvoiceRequestFormHandler. -->
      <dsp:input bean="CreateInvoiceRequestFormHandler.invoiceRequest.PONumber" type="text" value=""/>
      ...
      <dsp:input bean="CreateInvoiceRequestFormHandler.newInvoiceRequest" type="submit" value=" Add "/>
