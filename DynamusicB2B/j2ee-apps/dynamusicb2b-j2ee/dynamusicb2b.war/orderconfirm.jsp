...
<dsp:form action="orderconfirm.jsp" method="post">
 ...
 <dsp:input bean="CommitOrderFormHandler.commitOrderSuccessURL" type="hidden" value="orderstatus.jsp"/>
 ...
 <dsp:input bean="CancelOrderFormHandler.cancelOrderSuccessURL" type="hidden" value="orderstatus.jsp"/>
