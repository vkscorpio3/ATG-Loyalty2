      ...
      <td width=55> </td>
        ...
        <table border=0 cellpadding=4 width=80%>
              ...
              <dsp:droplet name="Switch">
                ...
                <dsp:oparam name="2">
                  <tr valign=top>
					...
					<dsp:a href="split_payment.jsp">Split order by dollar amount</dsp:a><br>
          ...
          <tr>
            ...
            <dsp:input bean="PaymentGroupFormHandler.applyPaymentGroupsErrorURL" type="hidden" value="my_billing.jsp?init=true"/>
